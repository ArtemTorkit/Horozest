  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="max-w-3xl mx-auto p-6 bg-white shadow-md rounded-lg">
        ...
        <p className="text-sm text-gray-600 mb-8">Last updated: August 22, 2024</p>
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>
            ...
            "Us" or "Our" in this Agreement) refers to Horozest.
          </li>
          <li>
        ...
        <p className="mb-4">
          ...
          the site, what pages they visit when they do so, and what other sites
          they used prior to coming to this site. We use the information we get
          from Google Analytics to improve our Service.
        </p>
        <p className="mb-4">
          We also use Google AdSense to display ads on our website. Google may
          use cookies to show ads based on your previous visits to our website
        ...
        <p className="mb-4">
          ...
          Act (CPRA). This means that you have rights regarding your personal
          data, including the right to access, correct, delete, and restrict the
          use of your data. You can exercise these rights by contacting us.
        </p>
        ...
        <p className="mb-4">
          Under the GDPR, if you are a resident of the European Economic Area
          (EEA), you have the following rights:
        </p>
        <ul className="list-disc list-inside mb-4">
          <li>
        ...
        <ul className="list-disc list-inside">
          <li>
            By email:{" "}
            <a
              href="mailto:artemtorkitdev@gmail.com"
              className="text-blue-500 hover:underline">
              artemtorkitdev@gmail.com
            </a>
          </li>
          {/* <li>
            By visiting this page on our website:{" "}
            <a
              href="https://www.horozest.com"
              className="text-blue-500 hover:underline">
              https://www.horozest.com
            </a>
          </li>
          <li>
            By phone number:{" "}
            <a href="tel:+48754342221" className="text-blue-500 hover:underline">
              +48 754 342 221
            </a>
          </li> */}
        </ul>
